...
public class SupplierController {
     ...
     */
    @GetMapping("/{id}")
    public ApiResponse<SupplierView> detail(@PathVariable("id") UUID id) {
     ...
     */
    @PutMapping("/{id}")
    public ApiResponse<SupplierView> update(@PathVariable("id") UUID id, @RequestBody SupplierSaveRequest request,
                                            @RequestHeader("Idempotency-Key") String idempotencyKey) {
    ...
    public ApiResponse<SupplierView> changeStatus(@PathVariable("id") UUID id, @RequestBody StatusChangeRequest request,
                                                  @RequestHeader("Idempotency-Key") String idempotencyKey) {
