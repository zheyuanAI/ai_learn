...
public class UomController {
     ...
     */
    @GetMapping("/{id}")
    public ApiResponse<UomView> detail(@PathVariable("id") UUID id) {
     ...
     */
    @PutMapping("/{id}")
    public ApiResponse<UomView> update(@PathVariable("id") UUID id, @RequestBody UomSaveRequest request,
                                       @RequestHeader("Idempotency-Key") String idempotencyKey) {
    ...
    public ApiResponse<UomView> changeStatus(@PathVariable("id") UUID id, @RequestBody StatusChangeRequest request,
                                             @RequestHeader("Idempotency-Key") String idempotencyKey) {
