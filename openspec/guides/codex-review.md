...
2. 阅读 `openspec/changes/<change-name>/spec.md`
3. 阅读 `openspec/changes/<change-name>/design.md`
4. 阅读 `openspec/changes/<change-name>/tasks.md`
5. 阅读 `openspec/changes/<change-name>/self-review.md`
6. 检查 `git diff`
7. 核对 Antigravity 汇报的测试命令与结果
8. 若本次变更影响现有事实文档，核对对应 `specs/`、`prototype/`、`docs/` 是否已同步回写
...
- 当前 git diff
- worker 汇报的测试结果
- 如有涉及，还要检查对应 specs/、prototype/、docs/ 的同步更新
